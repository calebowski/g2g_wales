...
## Biggest discrepancies in model vs obs
...
worst_mismatches <-worst_mismatches[worst_mismatches$rank_diff >=3] ## filter by where qt was a difference of 3
...
for (i in 1:ncol(worst_mismatches)){
  ...
  hg <- make.hydrograph(event_data, g2g_id, storm.name = event, cdata = wales_cdata, qt.data = filtered_qt)
  print(hg)
}
